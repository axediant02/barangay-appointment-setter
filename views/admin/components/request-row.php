...
<tr class="group hover:bg-slate-50 transition-colors">
    ...
    <td class="px-6 py-5 text-center w-24">
        <div class="flex items-center justify-center gap-2">
            <button type="button" onclick='openQuickUpdateModal(<?= $reqJson ?>)' class="h-9 w-9 flex items-center justify-center bg-teal-50 text-teal-600 rounded-xl hover:bg-teal-600 hover:text-white transition-all shadow-sm border border-teal-100" title="Quick Status Update">
